...
- [ ] **Send from the authenticated domain, not gmail - fixes first-email-to-spam. Cheap now: NO new DNS records needed.** (Added 06/08/2026 after One Story hit the same problem and solved it.)
