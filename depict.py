...
def build_prompt(dispatch: dict) -> str:
    ...
    return (
        ...
        "instant of peak action.\n"
        "BUT THE MOMENT MUST BE THE ONE IN THE HEADLINE. Reporting it plainly "
        "does not mean reporting something else that also happened. If the "
        "headline is about a thing being done, draw someone doing it; do not "
        "retreat to the aftermath, the recovery, the paperwork or the tidy-up "
        "unless the aftermath IS the story. 19/08/2026, on a dispatch about a "
        "woman marching her family onto a station hull in matching jumpers for a "
        "photograph, the brief came back as that woman later, alone, in a "
        "recovery bunk with a ball of wool: true, plain, and not the story. It "
        "should have been her at the tripod on the hull in the jumper she "
        "knitted. One figure doing the headline's action beats two figures doing "
        "something adjacent to it.\n"
        "DESCRIBE THE WHOLE OF WHAT THE PERSON IS WEARING, head to foot, in the "
        ...
        "engraving turns every extra face into mush. If the story involves many "
        "people, draw ONE OF THEM - never a bystander.\n"
        "THE PERSON IN FRAME MUST BE THE PERSON THE HEADLINE IS ABOUT, and "
        "whatever identifies them - their dress, uniform, habit, tools, what "
        "they are holding - has to be in the `subject` clause. A reader seeing "
        "the picture beside the headline must be able to tell it is the same "
        "story.\n"
        "This is the commonest way the picture goes wrong. On 18/08/2026, for a "
        "dispatch about six nuns guarding a burst pipe, the brief came back as a "
        "lone station fitter standing at a cart: a real moment from the story, "
        "correctly plain, and completely unrecognisable as it. The subject "
        "should have been one nun in an oil-soaked habit holding a wrench.\n\n"
        f"HEADLINE: {headline}\n"
